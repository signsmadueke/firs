                ...
                <div class="onboarding-content p-5 mt-5">
                    ...
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="attach">Upload an Attachment</label>
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="attach">
                                        <label class="custom-file-label" for="attach">Attach a Document</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row pt-3">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="paymentpurpose" class="form-control" rows="2" style="resize: none;"></textarea>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                ...
                <div class="onboarding-content p-5 mt-5">
                    ...
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="fname">First Name</label><input name="name" value="Signs" class="form-control" data-error="Please input the First Name" placeholder="eg: John" required="required" type="text">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
